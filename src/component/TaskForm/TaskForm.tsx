...
//to handle all input types(input,textarea,select)
  ...
  return (
    <form  className="flex flex-col gap-4 mt-10 border-1 rounded-md text-center py-10"  onSubmit={handleSubmit}>
      {/* <h3>Task Form</h3> */}
      {/* title input */}
      <div>
      <input className='border-1 rounded-l-md border-white-500 text-black pl-2'
      ...
      {/* Description Textarea */}
      <div>
      <textarea className='border-1 rounded-l-md border-white-500 text-black pl-2'
       placeholder="Description"
       name="description" 
       value={formData.description}
       onChange={handleChange}
      ...
      {/* status Select */}
      <div>
      <select className='border-1 rounded-l-md border-white-500 text-black pl-2'
      name='status' value={formData.status} onChange={handleChange}>
          {statusDropown.map(s =>(
              <option key={s} value={s}>{s.charAt(0).toUpperCase() + s.slice(1)} </option>
          ))}
      ...
      <button className='border-1 rounded-md border-white-500 text-black px-2 w-50 ml-35'  type="submit">Add Task</button>
